        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-xl relative overflow-hidden">
            <div className="hidden md:block mb-6">
              ...
              <p className="text-slate-500 text-sm mt-1">Access your personalized preparation environment</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="#" className="text-xs font-bold text-indigo-600 hover:text-indigo-700 transition">
                    Forgot Password?
                  </Link>
                </div>
                <div className="relative">
